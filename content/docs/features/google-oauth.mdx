  ...
  <Tab value="Better Auth + MongoDB">
    <Steps>
      <Step>
        ...
        (Follow the same steps as above for creating a project, consent screen, and OAuth credentials.)

        - Use <code>http://localhost:3000/api/auth/callback/google</code> and <code>https://your-domain.com/api/auth/callback/google</code> for redirect URIs.
  ...
  <Tab value="Better Auth + Supabase">
    <Steps>
      ...
      <Step>
        ...
        <CodeBlock title="Supabase Dashboard" lang="txt">
